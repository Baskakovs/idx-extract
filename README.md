...
The sync pipeline runs automatically via GitHub Actions on the 1st and 15th of each month. See [Actions](../../actions/workflows/stoxx-sync.yml) for run history.
